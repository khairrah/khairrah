...
<div class="bg-gradient-to-r from-blue-200 to-sky-200 p-6 rounded-xl shadow mb-6">
    ...
    <p class="text-sm text-black">
        Update data buku yang sudah ada di dalam sistem
    </p>
</div>
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="kode"
                       value="{{ old('kode', $book->kode) }}"
                       class="w-full border rounded px-3 py-2 text-sm text-black bg-gray-100 cursor-not-allowed" readonly>
            </div>
